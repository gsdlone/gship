...
<div class="container-fluid" style="width:90%;">
  ...
  <p><span style="color:red">署名顺序：</span>填写你在文章或专利中的作者署名顺序。对于第一单位文章，一作或共同一作，分区分数以权重 1.0 计入总分区分数，二作权重为 0.5，三作为 0.3，三作以后计为 0。</p>
  <p><span style="color:red">第一单位文章：</span>勾选后文章以第一单位文章录入系统，非第一单位文章权重为 0。</p>
